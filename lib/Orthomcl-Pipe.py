...
print "%s/mcl mclInput --abc -I 1.5 -o mclOutput_I1_5" % (MCL)
os.system("%s/mcl mclInput --abc -I 1.5 -o mclOutput_I1_5" % (MCL))
print "%s/orthomclMclToGroups H 000000 < mclOutput_I1_5 > mclOutput_I1_5.group" % (ORTHOMCLPATH)
os.system("%s/orthomclMclToGroups H 000000 < mclOutput_I1_5 > mclOutput_I1_5.group" % (ORTHOMCLPATH))

print "%s/mcl mclInput --abc -I 2.0 -o mclOutput_I2_0" % (MCL)
os.system("%s/mcl mclInput --abc -I 2.0 -o mclOutput_I2_0" % (MCL))
print "%s/orthomclMclToGroups H 000000 < mclOutput_I2_0 > mclOutput_I2_0.group" % (ORTHOMCLPATH)
os.system("%s/orthomclMclToGroups H 000000 < mclOutput_I2_0 > mclOutput_I2_0.group" % (ORTHOMCLPATH))

print "%s/mcl mclInput --abc -I 4.0 -o mclOutput_I4_0" % (MCL)
os.system("%s/mcl mclInput --abc -I 4.0 -o mclOutput_I4_0" % (MCL))
print "%s/orthomclMclToGroups H 000000 < mclOutput_I4_0 > mclOutput_I4_0.group" % (ORTHOMCLPATH)
os.system("%s/orthomclMclToGroups H 000000 < mclOutput_I4_0 > mclOutput_I4_0.group" % (ORTHOMCLPATH))
